...
// const bushesData = [
//   { scale: 0.5, position: new THREE.Vector3(0.8, 0.2, 2.2) },
//   { scale: 0.25, position: new THREE.Vector3(1.4, 0.1, 2.1) },
//   { scale: 0.4, position: new THREE.Vector3(-1, 0.05, 2.6) },
//   { scale: 0.15, position: new THREE.Vector3(-0.8, 0.1, 2.2) },
// ];

// const bushes = bushesData.map((data) => {
//   const bush = new THREE.Mesh(bushGeometry, bushMaterial);
//   bush.scale.set(data.scale, data.scale, data.scale);
//   bush.position.copy(data.position);
//   return bush;
// });
...
window.addEventListener("resize", () => {
  ...
  // No need to recreate the renderer and composer here.
});
...
const tick = () => {
  ...
  if (composer) {
    ...
    console.error("Composer is undefined");
  }
