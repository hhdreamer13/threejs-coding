...
// moderate cost light : directional, point
// high cost light : spotlight, rectArea
...
const pointLight = new THREE.PointLight("red", 0.5, 10, 2);
scene.add(pointLight);

// works only with standard and physical material
const rectAreaLight = new THREE.RectAreaLight("purple", 2, 3, 1);
rectAreaLight.position.set(-1.5, 0, 1.5);
rectAreaLight.lookAt(new THREE.Vector3());
scene.add(rectAreaLight);

const spotLight = new THREE.SpotLight("yellow", 0.4, 6, Math.PI * 0.1, 0.25, 1);
